...
import { X, GraduationCap, Mail, Lock, User, ArrowRight, CheckCircle2 } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl border border-slate-200 shadow-2xl max-w-md w-full p-6 sm:p-8 relative overflow-hidden">
        ...
        <h2 className="text-xl font-extrabold text-slate-900 tracking-tight">
          ...
          {mode === 'register' && 'Create Your Student OS Account'}
            ...
            {mode === 'register' && (
              <>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div>
                    <label className="block text-xs font-bold text-slate-700 mb-1">Major</label>
                    <input
                      type="text"
                      value={major}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="alex.rivers@campus.edu"
                  className="w-full pl-9 pr-3 py-2 text-xs rounded-xl bg-slate-50 border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                />
              </div>
            </div>
