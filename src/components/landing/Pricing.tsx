  ...
  const plans = [
    {
      ...
      features: [
        ...
        'Basic Assignment Solver & Standard Resume Builder',
      ],
      popular: false,
    ...
    },
    {
      ...
      period: 'per month',
      desc: 'Unlimited assignment solving, DSA sheet solutions & full study suites for active students.',
      features: [
